 ...
 * @author Silex RPR
 */
public class modificarItemInventarioPanel extends javax.swing.JPanel {
     ...
     */
    public modificarItemInventarioPanel(Item item) {
        initComponents();
        ...
        nombreTextField.setText(item.getNombre());
        placaTextField.setEnabled(false);
        placaTextField.setText(item.getPlacaInventario());
        fabricantesComboBox.setSelectedItem(item.getFabricante());
        inicialSpinner.setValue(item.getCantidadInicial());
        minimaSpinner.setValue(item.getCantidadMinima());
        tiempoMaximoSpinner.setValue(item.getTiempoMaximo());
        tiempoMaximoTipoComboBox.setSelectedItem(item.getTiempoMaximoTipo().toString());
        frecuenciaMinimaSpinner.setValue(item.getFrecuenciaMinima());
        frecuenciaMaximaSpinner.setValue(item.getFrecuenciaMaxima());
        frecuenciaMinimaTipoComboBox.setSelectedItem(item.getFrecuenciaMinimaTipo().toString());
        frecuenciaMaximaTipoComboBox.setSelectedItem(item.getFrecuenciaMaximaTipo().toString());
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("MODIFICANDO ITEM DE INVENTARIO");
