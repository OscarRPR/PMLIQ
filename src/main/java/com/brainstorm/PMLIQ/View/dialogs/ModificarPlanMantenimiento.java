 ...
 * @author Silex RPR
 */
public class ModificarPlanMantenimiento extends javax.swing.JDialog {

    /**
     * Creates new form CrearPlanMantenimiento
     */
    public ModificarPlanMantenimiento(java.awt.Frame parent, boolean modal, List<PlanMantenimiento> planes, int indice) {
        super(parent, modal);
        
        initComponents();
        
        setTitle("Modificando un plan de mantenimiento");
        setResizable(false);
        
        this.planes = planes;
        this.actividades = planes.get(indice).getCheckList();
        this.indice = indice;
        ...
        checkList.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && !e.isConsumed()) {
                    e.consume();
                    int selectedRow = checkList.getSelectedIndex();
                    String nombre = (String) checklistModel.getElementAt(selectedRow);
                    int indice = getActividad(nombre);
                    ModificarElementoCheckList modificarElementoCheckList = new ModificarElementoCheckList(
                            (JFrame)PMLIApp.getInstance().getMainWindow(), true, actividades, indice);
        
                    modificarElementoCheckList.addWindowListener(new WindowAdapter() {
                            @Override
                    ...
                    modificarElementoCheckList.setLocationRelativeTo(null);
                    modificarElementoCheckList.setVisible(true);
                }
            }
        });  
        
        nombreTextField.setText(planes.get(indice).getNombre());
        codigoTextField.setEnabled(false);
        codigoTextField.setText(planes.get(indice).getCodigo());
        tipoComboBox.setSelectedItem(planes.get(indice).getTipoPlan().toString());
        responsableTextField.setText(planes.get(indice).getResponsable());
        maxRegistrosSpinner.setValue(planes.get(indice).getMaximoRegistros());
        usoSpinner.setValue(planes.get(indice).getFrecuenciaUso());
        tiempoSpinner.setValue(planes.get(indice).getTiempo());
        tiempoComboBox.setSelectedItem(planes.get(indice).getTiempoTarea().toString());
        prioridadComboBox.setSelectedItem(planes.get(indice).getPrioridad().toString());
        
        updateListModel();
    }

    private int getActividad(String nombre) {
        int indiceAct = 0;
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(tiempoComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        ...
        {
            planes.set(indice, PMLIApp.getInstance().getAdmEquipos().crearPlanMantenimiento(planEquipo, actividades));
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarPlanMantenimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarPlanMantenimiento dialog = new ModificarPlanMantenimiento(new javax.swing.JFrame(), true, 
                                                new ArrayList<PlanMantenimiento>(), 0);
