 ...
 * @author Silex RPR
 */
public class ModificarEquipoAsociado extends javax.swing.JDialog {

    /**
     * Creates new form CrearEquipoAsociado
     */
    public ModificarEquipoAsociado(java.awt.Frame parent, boolean modal, List<EquipoAsociado> equipos, int indice) {
        super(parent, modal);
        initComponents();
        
        setTitle("Modificando un equipo asociado");
        setResizable(false);
        
        this.equipos = equipos;
        this.indice = indice;
        
        nombreTextField.setText(equipos.get(indice).getNombre());
        placaTextField.setEnabled(false);
        placaTextField.setText(equipos.get(indice).getPlacaInventario());
    }
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        ...
        {
            equipos.set(indice, PMLIApp.getInstance().getAdmEquipos().crearEquipoAsociado(equipoAsociado));
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarEquipoAsociado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarEquipoAsociado dialog = new ModificarEquipoAsociado(new javax.swing.JFrame(), true, 
                                                 new ArrayList<EquipoAsociado>(), 0);
