 ...
 * @author Silex RPR
 */
public class ModificarAccesorio extends javax.swing.JDialog {
    
    /**
     * Creates new form CrearAccesorio
     */
    public ModificarAccesorio(java.awt.Frame parent, boolean modal, List<Accesorio> accesorios, int indice) {
        super(parent, modal);
        initComponents();
        
        setTitle("Modificando un accesorio");
        setResizable(false);
        
        this.accesorios = accesorios;
        this.indice = indice;
        
        cantidadSpinner.setValue(accesorios.get(indice).getCantidad());
        nombreTextField.setText(accesorios.get(indice).getNombre());
        nombreTextField.setEnabled(false);
        marcaTextField.setText(accesorios.get(indice).getMarca());
        caracteristicasTextArea.setText(accesorios.get(indice).getCaracteristicas());
    }
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        ...
        {
            accesorios.set(indice, PMLIApp.getInstance().getAdmEquipos().crearAccesorio(accesorioEquipo));
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        /*java.awt.EventQueue.invokeLater(new Runnable()*/Runnable doWorkRunnable = new Runnable() {
            ...
            public void run() {
                ...
                ModificarAccesorio dialog = new ModificarAccesorio(new javax.swing.JFrame(), true, 
                                                new ArrayList<Accesorio>(), 0);
