 ...
 * @author Silex RPR
 */
public class FabricanteDAO extends BasicDAO<Fabricante, Integer> {

    public FabricanteDAO(Mongo mongo, Morphia morphia, String dbName) {
        super(mongo, morphia, dbName);
    }
    
    public List findAll()
    {
        return ds.find(Fabricante.class).asList();
    }
